...
import static seedu.timeforwheels.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.timeforwheels.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
import static seedu.timeforwheels.logic.commands.CommandTestUtil.VALID_TAG_FRIEND;
...
public class AddCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + DATE_DESC_AMY, new AddCommand(expectedCustomer));
    }
